...
export default function HeroSection() {
  ...
  if (!isClient) {
    return (
      ...
      >
        {/* Placeholder - giống layout thực */}
        <div className="relative z-20 text-center px-6 mt-10 md:mt-16">
          <h1 className="font-holtwood leading-none tracking-tight text-white drop-shadow-2xl text-[16vw] sm:text-[12vw] md:text-[10vw] lg:text-[8vw] xl:text-[7vw]">
            PHAM HONG
          </h1>
        </div>

        <div className="relative w-full overflow-hidden mt-8 md:mt-10">
          <div className="flex whitespace-nowrap text-[0.9rem] sm:text-[1rem] md:text-[1.1rem] font-light uppercase tracking-[0.25em] text-accent/90">
            <span className="mr-12">
              CREATIVE ✦ DEVELOPER ✦ FREELANCER ✦ DESIGNER ✦
            </span>
          </div>
        </div>

        <div className="w-full flex justify-center mt-6 md:mt-10 z-10">
          <Image
            src="/ziyu.jpg"
            alt="Hero Visual"
            width={500}
        ...
        <div className="relative max-w-7xl w-full px-8 md:pr-16 flex flex-col md:flex-row gap-8 md:gap-12">
          ...
          <div className="max-w-lg text-white/85 space-y-4 text-sm md:text-base leading-relaxed font-light tracking-wide md:pr-28 text-justify">
            <p>
              ...
              crafting thoughtful and user-friendly digital solutions. I enjoy
              designing and developing applications that are both functional and
              engaging, combining careful attention to detail with a creative
              approach.
            </p>
            <p>
              I am passionate about building tools that simplify complex tasks
              and enhance user experience, continuously refining my skills and
